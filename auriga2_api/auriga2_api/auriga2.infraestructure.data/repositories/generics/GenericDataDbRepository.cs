...
using auriga2.infraestructure.data.exceptions;
using Microsoft.EntityFrameworkCore;

namespace auriga2.infraestructure.data.repositories.generics
{
     public abstract class GenericDataDbRepository<T> : IGenericDataRepository<T> where T : class
    {
        public Auriga2Context Context { get; set; }

        public GenericDataDbRepository(Auriga2Context contex)
        {
            Context = contex;
        }
