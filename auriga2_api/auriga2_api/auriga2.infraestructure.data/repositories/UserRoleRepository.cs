...
public class UserRoleRepository : GenericDataDbRepository<UserRoleEntity>, IUserRoleDomainRepository
{
    public UserRoleRepository(Auriga2Context contex) : base(contex)
    {
        Context = contex;
    }
}