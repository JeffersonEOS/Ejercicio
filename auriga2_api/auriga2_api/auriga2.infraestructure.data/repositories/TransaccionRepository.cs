...
{
    public class TransaccionRepository : GenericDataDbRepository<TransaccionEntity>, ITransaccionDomainRepository
    {
        public TransaccionRepository(Auriga2Context context) : base(context)
        {
            Context = context;
        }
    }
